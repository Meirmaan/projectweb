...
<head>
    ...
    <script>
    	function validateForm() {
		    ...
		    var x = document.forms["myForm"]["password"].value;
		    var y = document.forms["myForm"]["r_password"].value;
		    if (x != y) {
...
<?php
	...
	//$conn_db = mysql_select_db("db_table");
	$user = 'root';
	$pass = '';
	$db = 'db_table';
	...
	if (isset($_POST['submit'])) {
		...
		if ($password == $r_password) {
			...
			//$query = mysql_query("INSERT INTO db_table VALUES('', '$username', '$login', '$password')") or die(mysql_error());
			$sql = "INSERT INTO table4 (username, login, password) VALUES ('".$username."', '".$login."', '".$password."' )";
			$welcome = "Welcome to our site"." ".$username.'!';
			echo $welcome;
			//echo $sql;
		}
		//else{
